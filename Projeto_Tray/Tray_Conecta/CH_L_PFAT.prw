...
cQuery += "         SUBSTRING(SF2.F2_EMISSAO,1,4)+'-'+SUBSTRING(SF2.F2_EMISSAO,5,2)+'-'+SUBSTRING(SF2.F2_EMISSAO,7,2)+'T'+SUBSTRING(SF2.F2_HORA,1,5)+':00.000-03:00'  DOCUMENTO_DATAEMISSAO,"
...
cQuery += "         INNER JOIN "+RetSqlName("SF2")+" (NOLOCK) SF2 ON 
